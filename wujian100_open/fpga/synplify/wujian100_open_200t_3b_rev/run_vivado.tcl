...
### $Header: //synplicity/ui202003syn/misc/run_vivado_template.tcl#1 $
### End History
################################################# 	
#################################################
###     SET DESIGN VARIABLES      ###
#################################################
set DesignName  	"wujian100_open"
set FamilyName  	"ARTIX7"
set DeviceName  	"XC7A200T"
set PackageName 	"FBG484"
set SpeedGrade  	"-2L"
set TopModule   	"wujian100_open_top"
set PartName    	"XC7A200TFBG484-2L"
set DcpFile			""
...
set SynpQueryFile "../${QueryFile}"
if {[file exists $SynpQueryFile] == 1} {
	file copy -force $SynpQueryFile $QueryFile
	source $QueryFile
	set DelayFile ${DesignName}_pnr.dly
	set SynpDelayFile "../${DelayFile}"
	file copy -force $DelayFile $SynpDelayFile
}
